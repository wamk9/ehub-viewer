  ...
  stages: {
    ...
    manage: {
      ...
      manage_view: {
        ...
        start_confirm_text: 'A partir de este momento, la información general del evento (nombre, descripción, inscripciones) quedará bloqueada y no podrá modificarse. Las etapas no iniciadas aún podrán crearse, editarse o eliminarse. Solo se podrán publicar artículos. ¿Deseas continuar?',
