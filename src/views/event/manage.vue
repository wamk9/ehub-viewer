        ...
        <div class="col-12 col-md-12 col-lg-12">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6 text-center">
                    <ehubInputImage v-model="newLeagueImage" />
                </div>
            </div>

            <div class="col-12">

                <ehubInput v-model="updatedLeagueData.name" :icon="['fas', 'address-card']" type="text"
                    placeholder="Nome da sua liga" />

                <ehubInput v-model="updatedLeagueData.route" :icon="['fas', 'link']" placeholder="URL da sua liga"
                    :disabled="true" />

                <ehubInput v-model="updatedLeagueData.description" icon="asterisk" type="textarea"
                    placeholder="Descrição" />

                <ehubButton @click="executeAction" text="Enviar dados" :disabled="sendingToApi" style="float: right" />
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    computed: {
        leagueImage() {
            return !this.newLeagueImage ? SystemVars.baseUrl + 'storage/league/' + this.refersTo + '/logo.webp?cache=' + this.cacheTimestamp : this.newLeagueImage;
        },
    },
    mounted() {
